...
### Calculate RMSE 1
```{r}
rmse(hxd$ve_L, predict(lm_met_ve1, data.frame(hxd)))
```

### Calculate RMSE 2
```{r}
rmse(hxd$ve_L, predict(lm_hr_ve2, data.frame(hxd)))
```

### Calculate RMSE 3
```{r}
rmse(hxd$ve_L, predict(lm_hr_ve3, data.frame(hxd)))
```

### Calculate RMSE 4
```{r}
rmse(hxd$ve_L, predict(lm_hr_ve4, data.frame(hxd)))
```

### Calculate RMSE lm5
```{r}
rmse(hxd$ve_L, predict(lm_hr_ve5, data.frame(hxd)))
```
